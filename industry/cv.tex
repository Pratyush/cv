...
\usepackage[maxnames=99, sorting=ydnt]{biblatex}
...
\DeclareCiteCommand{\cvcite}
  {\usebibmacro{prenote}}
  {%
    \usebibmacro{maintitle+title}{\labelnamepunct}
    \newline\nopunct\newblock
    \usebibmacro{author}{\labelnamepunct}\hfill
    \newline\newblock
    \iffieldundef{series}
    {\printfield{howpublished}{\labelnamepunct}}
    {}%
    \usebibmacro{series+number}{\labelnamepunct}
    \newline\nopunct\newblock
    \newline
  }
  {\multicitedelim}
...
\begin{cv}{\vspace{-5em}}
...

  {
    \small
    \noindent
    \cvcite{BoweCGMMW18, MishraPCCP18, ChiesaGLMMM17, CarliniMVZSSWZ16, HoLMHSW16, PortnoffLEMLW15}
    \vspace{-2em}
  }
